...
function PaymentDrawer({ open, onClose }) {
  ...
  const handleUpgrade = async (plan) => {
    try {
      ...
      const options = {
        ...
        // Step 4: Popup theme color
        theme: {
          color: "#4F46E5", // Indigo shade for branding
        },
      };
  ...
  return (
            ...
            <div className="px-5 flex-1 overflow-auto space-y-4">
              <div className="rounded-xl border border-white/10 p-4">
                ...
                <button
                  ...
                  className="mt-4 w-full rounded-lg cursor-pointer bg-indigo-600 hover:bg-indigo-700 py-2 text-white"
                >
                  Upgrade
                </button>
              </div>
    ...
    // AnimatePresence beacuse we have used exit
  );
}
