// This for coding agent to show the code and preview i.e for coding relates
...
function Artifact() {
  const { Artifacts } = useSelector((state) => state.messages);
        ...
        <div className="flex flex-col h-full bg-[#0d0f14]">
          ...
          hover:bg-white/[0.05] transition-colors duration-150 bg-transparent border-none cursor-pointer shrink-0"
            ...
            <div className="flex items-center gap-1 shrink-0">
              <button
                className="flex items-center gap-1.5 px-2.5 py-1.5 text-[11px] font-medium text-slate-400 hover:text-slate-200 hover:bg-white/[0.05] rounded-lg transition-colors 
